...
import { useAdminContentSections } from '../../hooks/useAdminContentSections'
    ...
    <section className="space-y-4">
      <div className="flex flex-wrap items-end justify-between gap-3">
        <div>
          ...
          <h2 className="text-3xl">Secciones de home</h2>
      ...
      >
        <form id="content-form" className="grid gap-3 md:grid-cols-2" onSubmit={onSubmit}>
          ...
          <label className="grid gap-1 text-sm font-medium text-zinc-700 dark:text-zinc-200 md:col-span-2">
            ...
            />
            {form.sectionType === 'gallery' && (
              <span className="text-xs font-normal text-zinc-500 dark:text-zinc-400">
                Formato galería:{' '}
                <code className="rounded bg-zinc-100 px-1 py-0.5 dark:bg-zinc-800">
                  {`{"items":[{"title":"...","imageUrl":"https://...","alt":"..."}]}`}
                </code>
              </span>
            )}
            {form.sectionType === 'locations' && (
              <span className="text-xs font-normal text-zinc-500 dark:text-zinc-400">
                Formato locations:{' '}
                <code className="rounded bg-zinc-100 px-1 py-0.5 dark:bg-zinc-800">
                  {`{"items":[{"tag":"Ceremonia","title":"Parroquia","description":"Dirección","mapUrl":"https://maps.google.com/..."}]}`}
                </code>
              </span>
            )}
              ...
              <UiButton
                ...
                onClick={() =>
                  setForm((current) => ({
                    ...current,
                    payloadJson:
                      '{"items":[{"title":"Momento especial","imageUrl":"https://...","alt":"Descripción"}]}',
                  }))
                }
              >
                Plantilla galería
